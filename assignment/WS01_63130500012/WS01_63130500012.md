...
ใช้เครื่องมือ min() เพื่อหาค่าต่ำสุดเเละทำการสรุปโดยเครื่องมือ summarise()
```
...
ใช้เครื่องมือ max() เพื่อหาค่าสูงสุดเเละทำการสรุปโดยเครื่องมือ summarise()
```
...
ใช้เครื่องมือ mean() เพื่อหาค่าเฉลี่ยเเละทำการสรุปโดยเครื่องมือ summarise()
```
